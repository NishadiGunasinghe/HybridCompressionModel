...
from compression_manger.CompressionLibraryService import validate
from test_compression.Util import _COMPRESSION_NAME, _COMPRESSION_ORDER, _COMPRESSION_FUNC, _DECOMPRESSION_FUNC, \
    _FUNC_OPTIONS, _COMPRESSED_CHUNK_SIZE, _UNCOMPRESSED_CHUNK_SIZE, _CHUNK_COMPRESSED_TIME
from test_compression.compression_manager.CompressionLibraryService import CompressionLibraryService


class CompressionTestLibraryServiceImpl(CompressionLibraryService):
